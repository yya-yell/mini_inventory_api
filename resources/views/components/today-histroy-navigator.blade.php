{{-- <div id="tody-history-navigator" class="position-fixed d-none" style="z-index:999; right : 0; top : 7rem;">
...
<x-helper.navigator ids="tody-history-navigator" :count="$count" header="Today History" >

    <button class="btn btn-info btn-sm mx-2 " id="th_create">Create</button>
